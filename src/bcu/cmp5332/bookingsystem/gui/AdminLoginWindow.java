...
/**
 * GUI window class for AdminLogin.
 ...
 */
    public AdminLoginWindow(FlightBookingSystem fbs) {
        this.fbs = fbs;
        initialize();
    }
 ...
 */
        ...
        JLabel headerLabel = new JLabel("Administrator Login");
        headerLabel.setFont(GUIUtils.FONT_HEADER);
        headerLabel.setForeground(GUIUtils.TEXT_WHITE);
        headerLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel subtitleLabel = new JLabel("Enter your admin credentials");
        ...
        // Buttons
        loginButton = GUIUtils.createStyledButton("Login");
        ...
        try {
            boolean authenticated =
                    AuthenticationService.authenticate(
                            fbs, username, password, Role.ADMIN
                    );

            if (authenticated) {
                dispose();
                new AdminPortalWindow(fbs);
            } else {
